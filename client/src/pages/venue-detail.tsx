  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      ...
      <div className="px-4 py-4 bg-white dark:bg-gray-800">
        <h2 className="text-sm text-gray-500 dark:text-white mb-4">
          <Bot className="inline w-8 h-8 mr-1 px-1" />
          {language === "ar" ? "تم توليدها بالذكاء الاصطناعي من مراجعات حقيقية" : "Generated by AI from real reviews"}
        </h2>
