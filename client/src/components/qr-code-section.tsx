...
export default function QRCodeSection({ reservation }: QRCodeSectionProps) {
  ...
  return (
    <div className="px-4 py-0 pb-4">
      <div className="bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-900 rounded-xl p-4 text-gray-900 dark:text-white cursor-pointer hover:from-gray-300 hover:to-gray-400 dark:hover:from-gray-700 dark:hover:to-gray-800 transition-all duration-200"
           onClick={() => {
